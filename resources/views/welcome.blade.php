    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                <h1 class="mb-3 font-bold text-3xl text-gray-900 dark:text-white">
                    Centralized Company Reports
                </h1>
                <p class="mb-6 text-lg text-[#706f6c] dark:text-[#A1A09A]">
                    Access and purchase official company reports across
                    <strong>Singapore, Mexico, Philippines, and Malaysia</strong> from a single platform.
                </p>

                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Login to your account to start searching and adding reports to your cart.
                </p>
            </div>
            {{-- Right Section --}}
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">

                <img src="{{ asset('images/search-vector.jpg') }}" alt="Company Reports Illustration"
